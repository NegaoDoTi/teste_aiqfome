...
@clients_route.get("/clients/{client_id}", response_class=JSONResponse)
async def find_client(client_id:int):
    return await ClientsView().find_clients(client_id)

@clients_route.get("/clients", response_class=JSONResponse)
async def find_clients():
    return await ClientsView().find_clients()
    
@clients_route.post("/clients", response_class=JSONResponse)
...
@clients_route.put("/clients/{client_id}")
